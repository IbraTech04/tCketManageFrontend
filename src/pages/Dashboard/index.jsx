...
const NAV = [
  ...
  { to: 'ticket-types',  icon: 'ticket',  label: 'Ticket Types' },
  { to: 'orders',        icon: 'card',    label: 'Orders' },
  { to: 'scanning',      icon: 'scan',    label: 'Scanning' },
];
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: 'var(--bg)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, overflow: 'hidden' }}>
        ...
        {/* Page content */}
        <main className="tm-scroll" style={{ flex: 1, overflowY: 'auto', background: 'var(--bg)' }}>
          <Routes>
